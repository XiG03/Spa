        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinSpendRequirement = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComboDetails", x => new { x.ComboId, x.ServiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplyToType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    MinOrderValue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TargetServiceId = table.Column<int>(type: "int", nullable: true),
                    TargetMembershipTypeId = table.Column<int>(type: "int", nullable: true),
                    DepositType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    DepositValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Priority = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepositRules", x => x.RuleId);
                    table.ForeignKey(
                        name: "FK_DepositRules_MembershipTypes_TargetMembershipTypeId",
                        column: x => x.TargetMembershipTypeId,
                        principalTable: "MembershipTypes",
                        principalColumn: "MembershipTypeId");
                    table.ForeignKey(
                        name: "FK_DepositRules_Services_TargetServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicianServices", x => new { x.EmployeeId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_TechnicianServices_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceConsumables", x => new { x.ServiceId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ServiceConsumables_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceConsumables_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "ServiceId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ComboId");
                    table.ForeignKey(
                        name: "FK_AppointmentDetails_Employees_TechnicianId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositDeduction = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentConsumables", x => x.UsageId);
                    table.ForeignKey(
                        name: "FK_AppointmentConsumables_AppointmentDetails_AppointmentDetailId",
                        column: x => x.AppointmentDetailId,
                        principalTable: "AppointmentDetails",
                        principalColumn: "AppointmentDetailId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentConsumables_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentConsumables_AppointmentDetailId",
                table: "AppointmentConsumables",
                column: "AppointmentDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentConsumables_ProductId",
                table: "AppointmentConsumables",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentDetails_TechnicianId",
                table: "AppointmentDetails",
                column: "TechnicianId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepositRules_TargetMembershipTypeId",
                table: "DepositRules",
                column: "TargetMembershipTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_DepositRules_TargetServiceId",
                table: "DepositRules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceConsumables_ProductId",
